...
/* ============ MODULES EXTRACTED (Phase 3 refactor) ============
   STORY MODE       → js/story.js       (v15.2) STORY state, modal, AI generator, exports
   CONTINUITY       → js/continuity.js  (v15.1) AI script supervisor + per-issue fixes
   FCPXML EXPORT    → js/fcpxml.js      (v15.0) Timeline ZIP for FCP/Resolve/Premiere
   Loaded via <script defer> in index.html AFTER app.js (which provides $, toast, aiCall, etc.) */
...
/* PROMPT HISTORY moved to js/history.js (Phase 3 v15.4) */
...
/* IMAGE-TO-PROMPT moved to js/i2p.js (Phase 3 v15.3) */
